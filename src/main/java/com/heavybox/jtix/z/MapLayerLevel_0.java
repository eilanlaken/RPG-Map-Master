...
public class MapLayerLevel_0 implements MapLayerLevel {
    ...
    public MapLayerLevel_0(int width, int height) {
        ...
        terrainGrass = Assets.get("assets/textures-layer-0/terrain_land_grass_0.jpg");
        ...
        terrainWater = Assets.get("assets/textures-layer-0/terrain_liquid_water_0.jpg");
        ...
        terrainStones = Assets.get("assets/textures-layer-0/terrain_land_stone_0.jpg");
    ...
    public void applyChanges(Renderer2D renderer2D) {
        ...
        for (CommandTerrain cmd : commandsQueueTerrainBlendMapStone) {
            Texture texture = cmd.mode == z_ToolBrushTerrain.Mode.ADD ? brushAdd : brushSub;
