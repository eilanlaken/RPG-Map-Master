...
public class SceneDemo implements Scene, RPGMapMakerScene {
    ...
    */
    ...
    public void start() {
        ...
        Assets.loadTexture("assets/textures-layer-0/terrain_land_stone_2.jpg", Texture.FilterMag.LINEAR, Texture.FilterMin.LINEAR_MIPMAP_LINEAR, Texture.Wrap.MIRRORED_REPEAT, Texture.Wrap.MIRRORED_REPEAT, 1);
