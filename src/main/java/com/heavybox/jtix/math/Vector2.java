...
//    }
    ...
    // TODO: test.
    public Vector2 transform_ScaleRotateTranslate(float x, float y, float deg, float sclX, float sclY) {
        this.scl(sclX, sclY);
        this.rotateDeg(deg);
        this.add(x, y);
        return this;
    ...
    public Vector2 transform_TranslateRotateScale(float x, float y, float deg, float sclX, float sclY) {
        this.add(x, y);
        this.rotateDeg(deg);
        this.scl(sclX, sclY);
        return this;
