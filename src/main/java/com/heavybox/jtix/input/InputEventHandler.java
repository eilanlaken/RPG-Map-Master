...
public interface InputEventHandler {
    ...
    default boolean mouseButtonsDown(int mouseX, int mouseY, @NotNull final Array<Mouse.Button> buttons) {
        return false;
    }

    default boolean mouseButtonsUp(int mouseX, int mouseY, @NotNull final Array<Mouse.Button> buttons) {
        return false;
    }
    ...
    default boolean mouseDragged(int mouseX, int mouseY, int deltaMouseX, int deltaMouseY, @NotNull final Array<Mouse.Button> buttons) {
        return false;
    }
